...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Certificate Detail
            ...
            <div class="p20">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 noBlock">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock" style="padding: 0px">
                        ...
                        <p><?php echo date("d-m-Y", strtotime($single_item->ce_date)); ?></p>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        ...
                        <p><?php echo $single_item->i_c8_name; ?></p>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noBlock">
                    <?php if($single_item->ce_img){ ?>
                        <img width="100%" src="<?php echo base_url('upload/certificates/'.$single_item->ce_img); ?>">
                    <?php }else{ ?>
