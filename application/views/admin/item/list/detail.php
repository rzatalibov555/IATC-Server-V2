            ...
            <div class="p20">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 noBlock">
                    <div id="aze" class="tab-content current">
                        ...
                        <p><?php echo $single_item->title_az; ?></p>

                        <br>

                        <label for="daze"><b>DESCRIPTION AZ</b></label>
                        <p><?php echo $single_item->description_az; ?></p>
                    ...
                    <div id="eng" class="tab-content">
                        ...
                        <p><?php echo $single_item->description_en; ?></p>
                        <br>
                    </div>
                    <div id="rus" class="tab-content">
                        ...
                        <p><?php echo $single_item->description_ru; ?></p>
                        <br>
                    </div>
                    <div id="tur" class="tab-content">
                        ...
                        <p><?php echo $single_item->description_tr; ?></p>
                        <br>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noBlock">
                    <?php if($single_item->img){ ?>
                        <img width="100%" src="<?php echo base_url('upload/events/'.$single_item->img); ?>">
                    <?php }else{ ?>
