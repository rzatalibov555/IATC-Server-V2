...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "<b>".$single_item->sl_title_az."</b>"." - Slider Edit"; ?>
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_updateItem_slAct/'.$single_item->sl_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <input type="text" name="title_az" id="taze" class="form-control" placeholder="Enter title" value="<?php echo $single_item->sl_title_az ; ?>">
                        ...
                        <textarea name="descr_az" rows="10" cols="50" id="daze" class="form-control"><?php echo $single_item->sl_description_az ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 noBlock">
                        ...
                        <label for="img2">IMG2 <br>
                            <img width="50px" src="https://www.iphonefaq.org/files/styles/large/public/files-a.jpg">
                        </label>
                        <input hidden type="file" name="user_file2" id="img2" class="form-control">
