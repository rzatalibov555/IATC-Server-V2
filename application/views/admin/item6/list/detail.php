            ...
            <div class="p20">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 noBlock">
                    <div id="aze" class="tab-content current">
                        ...
                        <p><?php echo $single_item->sl_title_az; ?></p>

                        <br>

                        <label for="daze"><b>DESCRIPTION AZ</b></label>
                        <p><?php echo $single_item->sl_description_az; ?></p>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                    <?php if($single_item->sl_img){ ?>
                        <img width="100%" style="height: 150px; object-fit: cover;"  src="<?php echo base_url('upload/slider/'.$single_item->sl_img); ?>">
                    <?php }else{ ?>
                        <img width="100%" style="height: 150px; object-fit: cover;"  src="<?php echo base_url('assets/admin/assets/images/no-img.png'); ?>">
                    <?php } ?>
                </div>

                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                    <?php if($single_item->sl_img2){ ?>
                        <img width="100%" style="height: 150px; object-fit: cover;" src="<?php echo base_url('upload/slider/'.$single_item->sl_img2); ?>">
                    <?php }else{ ?>
                        <img width="100%" style="height: 150px; object-fit: cover;"  src="<?php echo base_url('assets/admin/assets/images/no-img.png'); ?>">
                    <?php } ?>
                </div>
