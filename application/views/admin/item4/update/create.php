...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "<b>".$single_item->ab_title_az."</b>"." - About Edit"; ?>
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_updateItem_abAct/'.$single_item->ab_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <input type="text" name="title_az" id="taze" class="form-control" placeholder="Enter title" value="<?php echo $single_item->ab_title_az ; ?>">
                        ...
                        <textarea name="descr_az" rows="10" cols="50" id="daze" class="form-control"><?php echo $single_item->ab_description_az ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
