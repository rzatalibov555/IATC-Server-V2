...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Register List
                        ...
                        <tbody>
                            ...
                            <?php $itemCount = 1; $for_switch=0; foreach ($items as $item){ $for_switch++; ?>
                                <tr>
                                    ...
                                    <td><?php echo $item->re_title_az; ?></td>
                                    <td class="text-center"><?php echo date("d-m-Y", strtotime($item->re_date)); ?></td>

                                    <td class="text-center">
                                        <?php if($item->re_img){ ?>
                                            <img width="50" src="<?php echo base_url('upload/register/'.$item->re_img); ?>">
                                        <?php }else{ ?>
