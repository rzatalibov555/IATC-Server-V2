...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Galereya Əlavə et
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('Gallery/add_gallery_act'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <input type="text" name="title_az" id="taze" class="form-control" placeholder="Başlıq">
                    ...
                    <div id="eng" class="tab-content">
                        ...
                        <input type="text" name="title_en" id="teng" class="form-control" placeholder="Başlıq">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="rus" class="tab-content">
                        ...
                        <input type="text" name="title_ru" id="trus" class="form-control" placeholder="Başlıq">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="tur" class="tab-content">
                        ...
                        <input type="text" name="title_tr" id="ttre" class="form-control" placeholder="Başlıq">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        <div class="row">
                            <button type="submit" class="btn btn-info btn-block" style="margin-top: 23px; height: 40px;">Əlavə et</button>
                        </div>
                    </div>
