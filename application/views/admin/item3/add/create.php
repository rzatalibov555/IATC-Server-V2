...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Teacher Create
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_create_item_t_act'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <label for="daze">SHORT BIO AZ</label>
                        ...
                        <input type="text" name="position_az" id="position" class="form-control" placeholder="Enter position">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="eng" class="tab-content">
                        ...
                        <label for="deng">SHORT BIO EN</label>
                        ...
                        <input type="text" name="position_en" id="position_en" class="form-control" placeholder="Enter position">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="rus" class="tab-content">
                        ...
                        <label for="drus">SHORT BIO RU</label>
                        ...
                        <input type="text" name="position_ru" id="position_ru" class="form-control" placeholder="Enter position">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="tur" class="tab-content">
                        ...
                        <label for="dtur">SHORT BIO TR</label>
                        ...
                        <input type="text" name="position_tr" id="position_tr" class="form-control" placeholder="Enter position">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="row">
                            ...
                            <input type="text" name="fb" id="fb" class="form-control" placeholder="Enter social network link">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="row">
                            ...
                            <input type="text" name="instagram" id="instagram" class="form-control" placeholder="Enter social network link">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="row">
                            ...
                            <input type="text" name="twitter" id="twitter" class="form-control" placeholder="Enter social network link">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div class="row">
                            ...
                            <input type="text" name="linkedin" id="linkedin" class="form-control" placeholder="Enter social network link">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
