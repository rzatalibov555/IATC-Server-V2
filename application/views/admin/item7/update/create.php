...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "<b>".$single_item->tr_title_az."</b>"." - Training Edit"; ?>
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_updateItem_trAct/'.$single_item->tr_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div id="aze" class="tab-content current">
                        ...
                        <input type="text" name="title_az" id="taze" class="form-control" placeholder="Enter title" value="<?php echo $single_item->tr_title_az ; ?>">
                        ...
                        <textarea name="descr_az" rows="10" cols="50" id="daze" class="form-control"><?php echo $single_item->tr_description_az ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="eng" class="tab-content">
                        ...
                        <input type="text" name="title_en" id="teng" class="form-control" placeholder="Enter title" value="<?php echo $single_item->tr_title_en ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_en" rows="10" cols="50" id="deng" class="form-control"><?php echo $single_item->tr_description_en ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="rus" class="tab-content">
                        ...
                        <input type="text" name="title_ru" id="trus" class="form-control" placeholder="Enter title" value="<?php echo $single_item->tr_title_ru ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_ru" rows="10" cols="50" id="drus" class="form-control"><?php echo $single_item->tr_description_ru ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div id="tur" class="tab-content">
                        ...
                        <input type="text" name="title_tr" id="ttre" class="form-control" placeholder="Enter title" value="<?php echo $single_item->tr_title_tr ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <textarea name="descr_tr" rows="10" cols="50" id="dtur" class="form-control"><?php echo $single_item->tr_description_tr ; ?></textarea>
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        <div class="row">
                            ...
                            <input type="date" name="date" id="date" class="form-control" value="<?php echo $single_item->tr_date ; ?>">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                            ...
                            <select id="cate" class="form-control" name="category">
                                ...
                                <?php foreach ($get_all_item_category as $item){ ?>
                                    <option <?php if($single_item->tr_category == $item->i_c7_id){ echo "SELECTED"; } ?> value="<?php echo $item->i_c7_id; ?>"><?php echo $item->i_c7_name; ?></option>
                                <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <select id="status" class="form-control" name="status">
                                ...
                                <?php foreach ($get_all_item_status as $item){ ?>
                                    <option <?php if($single_item->tr_status == $item->i_s_id){ echo "SELECTED"; } ?> value="<?php echo $item->i_s_id; ?>"><?php echo $item->i_s_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <!-- form validation start display show -->
