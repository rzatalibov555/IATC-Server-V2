               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="page__title-wrapper mt-110">
                        <h3 class="page__title"><?php echo $this->lang->line('about'); ?></h3>                         
                     ...
                     <div class="about__thumb-wrapper">
                        ...
                        <div class="about__student ml-270 mt--80">
                           <a href="#">
                              ...
                              <img src="<?php echo base_url('assets/user/') ?>assets/img/about/student-2.jpg" alt="">
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content pl-70 pr-60 pt-25">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title"><br><span class="yellow-bg-big"><?php echo $about['ab_title_'.$this->session->userdata('lang_code')]; ?> <img src="<?php echo base_url('assets/user/') ?>assets/img/shape/yellow-bg-2.png" alt=""></span></h2>
                           <?php echo $about['ab_description_'.$this->session->userdata('lang_code')]; ?>
                        </div>
...
<!--                           </ul>-->
<!--                        </div>-->
<!--                        <a href="contact.php" class="e-btn e-btn-border">apply now</a>-->
                     </div>
                  </div>
               </div>
            </div>
...
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-1.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                           <div class="swiper-slide">-->
<!--                              <div class="brand__item text-center text-lg-start">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-2.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                           <div class="swiper-slide">-->
<!--                              <div class="brand__item text-center text-lg-start">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-3.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                           <div class="swiper-slide">-->
<!--                              <div class="brand__item text-center text-lg-start">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-4.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                           <div class="swiper-slide">-->
<!--                              <div class="brand__item text-center text-lg-start">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-5.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                           <div class="swiper-slide">-->
<!--                              <div class="brand__item text-center text-lg-start">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/brand/brand-6.png" alt="">-->
<!--                              </div>-->
<!--                           </div>-->
<!--                        </div>-->
<!--                        </div>-->
...
<!--                        <a href="about.php" class="link-btn">-->
<!--                           View all partners-->
...
<!--         <section class="testimonial__area pt-145 pb-150" data-background="--><?php //echo base_url('assets/user/') ?><!--assets/img/testimonial/home-3/testimonial-bg-3.jpg">-->
<!--            <div class="container">-->
<!--               <div class="row">-->
...
<!--                                    <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/testimonial/home-3/testi-1.jpg" alt="">-->
<!--                                </div>-->
<!--                             </div>-->
<!--                             <div class="swiper-slide">-->
<!--                                 <div class="testimonial__nav-thumb">-->
<!--                                    <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/testimonial/home-3/testi-2.jpg" alt="">-->
<!--                                 </div>-->
<!--                             </div>-->
<!--                             <div class="swiper-slide">-->
<!--                                 <div class="testimonial__nav-thumb">-->
<!--                                    <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/testimonial/home-3/testi-3.jpg" alt="">-->
<!--                              </div>-->
<!--                             </div>-->
<!--                             <div class="swiper-slide">-->
<!--                                 <div class="testimonial__nav-thumb">-->
...
<!--                           <h2 class="section__title">Tools for <span class="yellow-bg yellow-bg-big">Teachers<img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/shape/yellow-bg.png" alt=""></span> and Learners</h2>-->
...
<!--                        </div>-->
<!--                        <div class="why__btn">-->
<!--                           <a href="contact.php" class="e-btn e-btn-3 mr-30">Join for Free</a>-->
<!--                           <a href="about.php" class="link-btn">-->
<!--                              Learn More -->
<!--                              <i class="far fa-arrow-right"></i>-->
<!--                              <i class="far fa-arrow-right"></i>-->
...
<!--                        <img src="--><?php //echo base_url('assets/user/') ?><!--assets/img/why/why.png" alt="">-->
<!--                        <img class="why-green" src="--><?php //echo base_url('assets/user/') ?><!--assets/img/why/why-shape-green.png" alt="">-->
<!--                        <img class="why-pink" src="--><?php //echo base_url('assets/user/') ?><!--assets/img/why/why-shape-pink.png" alt="">-->
<!--                        <img class="why-dot" src="--><?php //echo base_url('assets/user/') ?><!--assets/img/why/why-shape-dot.png" alt="">-->
<!--                        <img class="why-line" src="--><?php //echo base_url('assets/user/') ?><!--assets/img/why/why-shape-line.png" alt="">-->
<!--                     </div>-->
<!--                  </div>-->
<!--               </div>-->
<!--            </div>-->
               ...
               <div class="row">
                  <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
                     <div class="section__title-wrapper text-center mb-60">
                        <h2 class="section__title">We are <span class="yellow-bg yellow-bg-big">Proud<img src="<?php echo base_url('assets/user/') ?>assets/img/shape/yellow-bg.png" alt=""></span></h2>
