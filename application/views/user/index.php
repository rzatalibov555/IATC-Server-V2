    ...
    <main>
       ...
       <section class="hero__area hero__height d-flex align-items-center grey-bg-2 p-relative">
          <div class="hero__shape">
             <img class="hero-1-circle" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-circle.png" alt="">
             <img class="hero-1-circle-2" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-circle-2.png" alt="">
             <img class="hero-1-dot-2" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-dot-2.png" alt="">
          </div>
          <div class="container">
                      ...
                      <div class="hero__content p-relative z-index-1">
                         <?php if ($slider_info) { ?>
                            <h3 class="hero__title">
                               <span></span>
                               <span class="yellow-shape">IATC <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg.png" alt="yellow-shape"> </span>
                               <?php echo  $slider_info[0]['sl_title_' . $this->session->userdata('lang_code')]; ?>
                            </h3>
                         <?php } ?>

                         <?php
                           if ($slider_info) {
                              echo $slider_info[0]['sl_description_' . $this->session->userdata('lang_code')];
                           }
                           ?>
                         <a href="<?php echo base_url('courses'); ?>" class="e-btn"><?php echo $this->lang->line('all_courses'); ?></a>
                      </div>
                   </div>
                   <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                      <div class="hero__thumb d-flex p-relative">
                         <div class="hero__thumb-shape">
                            <img class="hero-1-dot" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-dot.png" alt="">
                            <img class="hero-1-circle-3" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-circle-3.png" alt="">
                            <img class="hero-1-circle-4" src="<?php echo base_url('assets/user/'); ?>assets/img/shape/hero/hero-1-circle-4.png" alt="">
                         </div>
                         <div class="hero__thumb-big mr-30">
                            <?php if ($slider_info) { ?>
                               <img src="<?php echo base_url('upload/slider/' . $slider_info[0]['sl_img']); ?>" alt="">
                            <?php } ?>
                         ...
                         <div class="hero__thumb-sm mt-50 d-none d-lg-block">
                            <?php if ($slider_info) { ?>
                               <img src="<?php echo base_url('upload/slider/' . $slider_info[0]['sl_img2']); ?>" alt="">
                            <?php } ?>
       ...
       <section class="category__area pt-120 pb-70">
          <div class="container">
             <div class="row align-items-end">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                   <div class="section__title-wrapper mb-45">
                      <h2 class="section__title"><span class="yellow-bg"><?php echo $this->lang->line('most'); ?> <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt=""> </span><?php echo $this->lang->line('categories'); ?>
                      </h2>
                   </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-4">
                   <div class="category__more mb-50 float-md-end fix">
                      <a href="<?php echo base_url('category_list'); ?>" class="link-btn">
                         <?php echo $this->lang->line('all_categories_text'); ?>
             ...
             <div class="row">
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Business</a></h4>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Art & Design</a></h4>-->
                <!--                           <p>Fun & Challenging</p>-->
                <!--                        </div>-->
                <!--                     </div>-->
                <!--                  </div>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Lifestyle</a></h4>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Marketing</a></h4>-->
                <!--                           <p>Improve your business</p>-->
                <!--                        </div>-->
                <!--                     </div>-->
                <!--                  </div>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Finance</a></h4>-->
                <!--                           <p>Fun & Challenging</p>-->
                <!--                        </div>-->
                <!--                     </div>-->
                <!--                  </div>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Health & Fitness</a></h4>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Music</a></h4>-->
                <!--                           <p>Major or Minor</p>-->
                <!--                        </div>-->
                <!--                     </div>-->
                <!--                  </div>-->
                ...
                <!--                        </div>-->
                <!--                        <div class="category__content">-->
                <!--                           <h4 class="category__title"><a href="course-details.php">Academics</a></h4>-->
          ...
          <div class="container">
             <div class="row align-items-end">
                <div class="col-xxl-12 col-xl-12 col-lg-12">
                   <div class="section__title-wrapper mb-60">
                      <h2 class="section__title"><span class="yellow-bg"><?php echo $this->lang->line('most'); ?> <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt=""> </span><?php echo $this->lang->line('our_courses'); ?>
                      </h2>
                   </div>
                </div>

                <div class="col-xxl-12 col-xl-12 col-lg-12">
                   <div class="course__menu d-flex justify-content-lg-end mb-60" style="display: flex!important; align-items: center!important;justify-content: center!important; text-align: center;">
                      <div class="masonary-menu filter-button-group">
                         <button class="active filterMenu_design" data-filter="*">

                            <?php echo $this->lang->line('our_all_courses'); ?>
                            <!--                              <span class="tag">Yeni</span>-->
                         </button>
                         <?php foreach ($allCategory_filter as $allCategory_filter_key) { ?>
                            <button class="filterMenu_design" data-filter=".cat<?php echo $allCategory_filter_key['i_c_id']; ?>"><?php echo $allCategory_filter_key['i_c_name']; ?></button>
                         <?php } ?>
             ...
             <div class="row grid">
                <?php foreach ($all_courses as $all_courses_key) { ?>
                   <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 grid-item cat<?php echo $all_courses_key['i_c_id']; ?>">
                         ...
                         <div class="course__thumb w-img p-relative fix">
                            ...
                            <a href="<?php echo base_url('course_single/' . $all_courses_key['c_id']); ?>">
                               ...
                               <?php if ($all_courses_key['img']) { ?>
                                  <img width="100%" style="object-fit: cover; height:195px;" src="<?php echo base_url('upload/courses/' . $all_courses_key['img']); ?>" alt="">
                               <?php } else { ?>
                                  <img height="195" style="object-fit: contain; object-position:bottom;" src="<?php echo base_url('assets/user/assets/img/logo/IATC_DarkLogo.png'); ?>" alt="">
                               <?php } ?>

                            </a>
                            <div class="course__tag">
                               <a style="padding: 0px 10px;" href="<?php echo base_url('category/' . $all_courses_key['i_c_id']); ?>"><?php echo $all_courses_key['i_c_name']; ?></a>
                            </div>
                         </div>
                         ...
                         <!-- <div class="course__more d-flex justify-content-between align-items-center">
                                    <div class="course__status status_course">
                                        ...
                                        <?php } elseif ($all_courses_key['t_status'] == '2') { ?>
                                            <span><?php echo $this->lang->line('deactive'); ?></span>
                ...
                <!--                              <img src="--><?php //echo base_url('assets/user/'); 
                                                               ?>
                <!--assets/img/course/course-2.jpg" alt="">-->
                <!--                           </a>-->
                <!--                           <div class="course__tag">-->
                ...
                <!--                                 <img src="--><?php //echo base_url('assets/user/'); 
                                                                  ?>
                <!--assets/img/course/teacher/teacher-2.jpg" alt="">-->
                <!--                              </div>-->
                ...
                <!--                              <img src="--><?php //echo base_url('assets/user/'); 
                                                               ?>
                <!--assets/img/course/course-3.jpg" alt="">-->
                <!--                           </a>-->
                <!--                           <div class="course__tag">-->
                ...
                <!--                                 <img src="--><?php //echo base_url('assets/user/'); 
                                                                  ?>
                <!--assets/img/course/teacher/teacher-3.jpg" alt="">-->
                <!--                              </div>-->
                ...
                <!--                              <img src="--><?php //echo base_url('assets/user/'); 
                                                               ?>
                <!--assets/img/course/course-4.jpg" alt="">-->
                <!--                           </a>-->
                <!--                           <div class="course__tag">-->
                ...
                <!--                                 <img src="--><?php //echo base_url('assets/user/'); 
                                                                  ?>
                <!--assets/img/course/teacher/teacher-4.jpg" alt="">-->
                <!--                              </div>-->
                ...
                <!--                              <img src="--><?php //echo base_url('assets/user/'); 
                                                               ?>
                <!--assets/img/course/course-5.jpg" alt="">-->
                <!--                           </a>-->
                <!--                           <div class="course__tag">-->
                ...
                <!--                              </div>-->
                <!--                           </div>-->
                <!--                           <h3 class="course__title"><a href="course-details.php">Build your media and Public presence</a></h3>-->
                <!--                           <div class="course__teacher d-flex align-items-center">-->
                <!--                              <div class="course__teacher-thumb mr-15">-->
                <!--                                 <img src="--><?php //echo base_url('assets/user/'); 
                                                                  ?>
                <!--assets/img/course/teacher/teacher-5.jpg" alt="">-->
                <!--                              </div>-->
                <!--                              <h6><a href="instructor-details.php">Pelican Steve</a></h6>-->
                <!--                           </div>-->
                <!--                        </div>-->
                <!--                        <div class="course__more d-flex justify-content-between align-items-center">-->
                <!--                           <div class="course__status d-flex align-items-center">-->
                ...
                <!--                              <img src="--><?php //echo base_url('assets/user/'); 
                                                               ?>
                <!--assets/img/course/course-6.jpg" alt="">-->
                <!--                           </a>-->
                <!--                           <div class="course__tag">-->
                ...
                <!--                              </div>-->
                <!--                           </div>-->
                <!--                           <h3 class="course__title"><a href="course-details.php">Creative writing through Storytelling</a></h3>-->
                <!--                           <div class="course__teacher d-flex align-items-center">-->
                <!--                              <div class="course__teacher-thumb mr-15">-->
                <!--                                 <img src="--><?php //echo base_url('assets/user/'); 
                                                                  ?>
                <!--assets/img/course/teacher/teacher-6.jpg" alt="">-->
                <!--                              </div>-->
                <!--                              <h6><a href="instructor-details.php">Shahnewaz Sakil</a></h6>-->
                <!--                           </div>-->
                <!--                        </div>-->
                <!--                        <div class="course__more d-flex justify-content-between align-items-center">-->
                <!--                           <div class="course__status d-flex align-items-center">-->
       ...
       <section class="events__area pt-115 pb-120 p-relative">
          <div class="events__shape">
             <img class="events-1-shape" src="<?php echo base_url('assets/user/'); ?>assets/img/events/events-shape.png" alt="">
          </div>
          <div class="container">
             <div class="row">
                ...
                <!--                        <h2 class="section__title">Current <span class="yellow-bg yellow-bg-big">Events<img src="--><?php //echo base_url('assets/user/'); 
                                                                                                                                          ?>
                <!--assets/img/shape/yellow-bg.png" alt=""></span></h2>-->
                ...
                <div class="row align-items-end">
                   <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                      <div class="section__title-wrapper mb-45">
                         <h2 class="section__title"><span class="yellow-bg"><?php echo $this->lang->line('events_our'); ?> <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-2.png" alt=""> </span>
                         </h2>
                      </div>
                   </div>
                   <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                      <div class="category__more mb-50 float-md-end fix">
                         <a href="<?php echo base_url('events'); ?>" class="link-btn">
                            <?php echo $this->lang->line('all_eventss'); ?>
                            <i class="far fa-arrow-right"></i>
                            <i class="far fa-arrow-right"></i>
                         </a>
                      </div>
             ...
             <div class="row">
                ...
                <?php foreach ($events as $events_key) { ?>
                         ...
                         <div class="events__item-inner d-sm-flex align-items-center justify-content-between white-bg">
                            <div class="events__content">
                               <div class="events__meta">
                                  <span><?php echo $events_key['ev_date']; ?></span>
                                  <span><?php echo $events_key['ev_duration']; ?></span>
                                  <span><?php echo $events_key['ev_schedule']; ?></span>
                               </div>
                               <h3 class="events__title"><a href="<?php echo base_url('event-details/' . $events_key['ev_id']); ?>"><?php echo $events_key['ev_title_' . $this->session->userdata('lang_code')]; ?></a></h3>
                            </div>
                            <div class="events__more">
                               <a href="<?php echo base_url('event-details/' . $events_key['ev_id']); ?>" class="link-btn">
                                  <?php echo $this->lang->line('more'); ?>
                                  <i class="far fa-arrow-right"></i>
                                  <i class="far fa-arrow-right"></i>
                               </a>
