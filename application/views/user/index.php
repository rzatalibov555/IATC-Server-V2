...
<!--                              <span class="tag">Yeni</span>-->
                            ...
                            <?php foreach ($allCategory_filter as $allCategory_filter_key) { ?>
                                <button data-filter=".cat<?php echo $allCategory_filter_key['i_c_id']; ?>"><?php echo $allCategory_filter_key['i_c_name']; ?></button>
                            <?php } ?>
...
<!--                        <div class="course__thumb w-img p-relative fix">-->
<!--                           <a href="course-details.php">-->
<!--                              <img src="--><?php //echo base_url('assets/user/'); ?><!--assets/img/course/course-5.jpg" alt="">-->
<!--                           </a>-->
<!--                           <div class="course__tag">-->
...
<!--                           <div class="course__teacher d-flex align-items-center">-->
<!--                              <div class="course__teacher-thumb mr-15">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/'); ?><!--assets/img/course/teacher/teacher-5.jpg" alt="">-->
<!--                              </div>-->
...
<!--                        <div class="course__thumb w-img p-relative fix">-->
<!--                           <a href="course-details.php">-->
<!--                              <img src="--><?php //echo base_url('assets/user/'); ?><!--assets/img/course/course-6.jpg" alt="">-->
<!--                           </a>-->
<!--                           <div class="course__tag">-->
...
<!--                           <div class="course__teacher d-flex align-items-center">-->
<!--                              <div class="course__teacher-thumb mr-15">-->
<!--                                 <img src="--><?php //echo base_url('assets/user/'); ?><!--assets/img/course/teacher/teacher-6.jpg" alt="">-->
<!--                              </div>-->
...
<!--                        <h2 class="section__title">Current <span class="yellow-bg yellow-bg-big">Events<img src="--><?php //echo base_url('assets/user/'); ?><!--assets/img/shape/yellow-bg.png" alt=""></span></h2>-->
