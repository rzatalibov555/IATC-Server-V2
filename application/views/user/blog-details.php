...
<?php $this->load->view('user/includes/other_navbar'); ?>
      ...
      <main>
         ...
         <section class="page__title-area page__title-height-2 page__title-overlay d-flex align-items-center" data-background="<?php echo base_url('assets/user/'); ?>assets/img/page-title/page-title-3.jpg">
            <div class="page__title-shape">
               <img class="page-title-shape-1" src="<?php echo base_url('assets/user/'); ?>assets/img/page-title/page-title-shape-1.png" alt="">
               <img class="page-title-shape-2" src="<?php echo base_url('assets/user/'); ?>assets/img/page-title/page-title-shape-2.png" alt="">
               <img class="page-title-shape-3" src="<?php echo base_url('assets/user/'); ?>assets/img/page-title/page-title-shape-3.png" alt="">
               <img class="page-title-shape-4" src="<?php echo base_url('assets/user/'); ?>assets/img/page-title/page-title-shape-4.png" alt="">
            </div>
            <div class="container">
               <div class="row">
                        ...
                        <div class="blog__meta d-flex align-items-center">
                           <div class="blog__author d-flex align-items-center mr-40">
                              <div class="blog__author-thumb mr-10">
                                 <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/author/author-1.jpg" alt="">
                              </div>
                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="blog__wrapper">
                        ...
                        <div class="blog__quote grey-bg mb-45 p-relative fix">
                           <img class="quote" src="<?php echo base_url('assets/user/'); ?>assets/img/blog/quote-1.png" alt="">
                           <blockquote>
                        ...
                        <div class="blog__img w-img mb-45" >
                           <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/big/blog-big-1.jpg" alt="">
                        </div>
                        <div class="blog__text mb-40">
                        ...
                        <div class="blog__author-3 d-sm-flex grey-bg mb-90">
                           <div class="blog__author-thumb-3 mr-20">
                              <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/author/blog-author-1.jpg" alt="">
                           </div>
                        ...
                        <div class="blog__recent mb-65">
                           <div class="section__title-wrapper mb-40">
                              <h2 class="section__title">Related <span class="yellow-bg-sm">Post <img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg-4.png" alt="">  </span></h2>
                           ...
                           <div class="row">
                                 ...
                                 <div class="blog__item white-bg mb-30 transition-3 fix">
                                    <div class="blog__thumb w-img fix">
                                       <a href="blog-details.php">
                                          <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-1.jpg" alt="">
                                       </a>
                                    </div>
                                    <div class="blog__content">
                                       ...
                                       <h3 class="blog__title"><a href="blog-details.php">The Challenge Of Global Learning In Public Education</a></h3>
                              ...
                              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                 <div class="blog__item white-bg mb-30 transition-3 fix">
                                    <div class="blog__thumb w-img fix">
                                       <a href="blog-details.php">
                                          <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-2.jpg" alt="">
                                       </a>
                                    </div>
                                    <div class="blog__content">
                                       <div class="blog__tag">
                                       ...
                                       <h3 class="blog__title"><a href="blog-details.php">Exactly How Technology Can Make Reading Better</a></h3>
            
                                       <div class="blog__meta d-flex align-items-center justify-content-between">
                                          <div class="blog__author d-flex align-items-center">
                                             <div class="blog__author-thumb mr-10">
                                                <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/author/author-2.jpg" alt="">
                                             </div>
                                             <div class="blog__author-info">
                                                <h5>Barry Tone</h5>
                                             </div>
                                 ...
                                 <div class="comments-box grey-bg">
                                    <div class="comments-info d-flex">
                                          <div class="comments-avatar mr-20">
                                                <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/comments/comment-1.jpg" alt="">
                                          </div>
                                 ...
                                 <ul>
                                    <li class="children-2">
                                       <div class="comments-box grey-bg">
                                          <div class="comments-info d-flex">
                                                <div class="comments-avatar mr-20">
                                                      <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/comments/comment-3.jpg" alt="">
                                                </div>
                                                <div class="avatar-name">
                                                   <h5>Von Rails</h5>
