                       ...
                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                           <div class="teacher__item text-center grey-bg-5 transition-3 mb-30">
                               ...
                               <div class="teacher__content">
                                   <h3 class="teacher__title"><?php echo $all_teachers_key['t_title_'.$this->session->userdata('lang_code')]; ?></h3>
                                   <br>
                                   ...
                                   <div class="teacher__social">
                                       ...
                                       <ul>
                                           ...
                                           <?php if ($all_teachers_key['t_instagram']){ ?>
                                               <li><a target="_blank" href="<?php echo $all_teachers_key['t_instagram']; ?>"><i class="social_instagram"></i></a></li>
                                            <?php } ?>

                                           <?php if ($all_teachers_key['t_twitter']){ ?>
                                               <li><a target="_blank" href="<?php echo $all_teachers_key['t_twitter']; ?>"><i class="social_twitter"></i></a></li>
                                            <?php } ?>

                                           <?php if ($all_teachers_key['t_linkedin']){ ?>
                                               <li><a target="_blank" href="<?php echo $all_teachers_key['t_linkedin']; ?>"><i class="social_linkedin"></i></a></li>
                                           <?php } ?>
                                       </ul>
                                   </div>
                               </div>
