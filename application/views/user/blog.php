                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                           <div class="blog__wrapper">
                              <div class="blog__item white-bg mb-30 transition-3 fix">
                                 <div class="blog__thumb w-img fix">
                                    <a href="blog-details.php">
                                       <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-3.jpg" alt="">
                                    </a>
                                 </div>
                                 <div class="blog__content">
                                    <div class="blog__tag">
                                    ...
                                    <h3 class="blog__title"><a href="blog-details.php">New Chicago school budget relies on state pension</a></h3>
         
                                    <div class="blog__meta d-flex align-items-center justify-content-between">
                                       <div class="blog__author d-flex align-items-center">
                                          <div class="blog__author-thumb mr-10">
                                             <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/author/author-3.jpg" alt="">
                                          </div>
                                          <div class="blog__author-info">
                                             <h5>Jim Séchen</h5>
                                          </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                           <div class="blog__wrapper">
                              <div class="blog__item white-bg mb-30 transition-3 fix">
                                 <div class="blog__thumb w-img fix">
                                    <a href="blog-details.php">
                                       <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-4.jpg" alt="">
                                    </a>
                                 </div>
                                 <div class="blog__content">
                                    <div class="blog__tag">
                                    ...
                                    <h3 class="blog__title"><a href="blog-details.php">Google Ads certifications: Are they worth it?</a></h3>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                           <div class="blog__wrapper">
                              <div class="blog__item white-bg mb-30 transition-3 fix">
                                 <div class="blog__thumb w-img fix">
                                    <a href="blog-details.php">
                                       <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-5.jpg" alt="">
                                    </a>
                                 </div>
                                 <div class="blog__content">
                                    <div class="blog__tag">
                                    ...
                                    <h3 class="blog__title"><a href="blog-details.php">14 Facebook Ad Examples for Ad Creative Inspiration</a></h3>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                           <div class="blog__wrapper">
                              <div class="blog__item white-bg mb-30 transition-3 fix">
                                 <div class="blog__thumb w-img fix">
                                    <a href="blog-details.php">
                                       <img src="<?php echo base_url('assets/user/'); ?>assets/img/blog/blog-6.jpg" alt="">
                                    </a>
                                 </div>
                                 <div class="blog__content">
                                    <div class="blog__tag">
                                    ...
                                    <h3 class="blog__title"><a href="blog-details.php">How to manage Facebook ads for clients the right way</a></h3>
