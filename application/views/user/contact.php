                  ...
                  <div class="col-xxl-7 col-xl-7 col-lg-6">
                     <div class="contact__wrapper">
                        <div class="section__title-wrapper mb-40">
                           <h2 class="section__title">Bizimlə<span class="yellow-bg yellow-bg-big"> əlaqə<img src="<?php echo base_url('assets/user/'); ?>assets/img/shape/yellow-bg.png" alt=""></span></h2>
                           <p>Bizə müraciət edə bilərsiniz</p>
                        </div>
                              ...
                              <div class="row">
                                 <div class="col-xxl-6 col-xl-6 col-md-6">
                                    <div class="contact__form-input">
                                       <input type="text" placeholder="Ad, soyad, ata adı" name="name">
                                    </div>
                                 </div>
                                 <div class="col-xxl-6 col-xl-6 col-md-6">
                                    <div class="contact__form-input">
                                 ...
                                 <div class="col-xxl-12">
                                    <div class="contact__btn">
                                       <button type="submit" class="e-btn">Göndər</button>
                                    </div>
                                 </div>
                              </div>
                           </form>
